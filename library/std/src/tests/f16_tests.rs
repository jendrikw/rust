...
#[allow(unused_macros)]
macro_rules! f16_assert_eq {
    ($a, $b) => {
        assert_eq!($a, $b, "comparing {:#018x} to {:#018x}", $a.to_bits(), $b.to_bits())
    };
}
...
macro_rules! assert_f16_biteq {
    ($left : expr, $right : expr) => {
        ...
        let lb = l.to_bits();
        let rb = r.to_bits();
        assert_eq!(lb, rb, "float {} ({:#018x}) is not equal to {} ({:#018x})", *l, lb, *r, rb);
    };
}
...
#[test]
fn test_constants() {
    assert_eq_f16!(f16::MIN_POSITIVE.to_bits(), SMALLEST_NORMAL_BITS);
}
...
#[test]
fn test_min_nan() {
    assert_eq_f16!(f16::NAN.min(2.0), 2.0);
    assert_eq_f16!(2.0f16.min(f16::NAN), 2.0);
}

#[test]
fn test_max_nan() {
    assert_eq_f16!(f16::NAN.max(2.0), 2.0);
    assert_eq_f16!(2.0f16.max(f16::NAN), 2.0);
}
...
fn test_nan() {
    ...
    assert_eq_f16!(Fp::Nan, nan.classify());
}
...
fn test_infinity() {
    ...
    assert_eq_f16!(Fp::Infinite, inf.classify());
}
...
fn test_neg_infinity() {
    ...
    assert_eq_f16!(Fp::Infinite, neg_inf.classify());
}

#[test]
fn test_zero() {
    let zero: f16 = 0.0f16;
    assert_eq_f16!(0.0, zero);
    ...
    assert_eq_f16!(Fp::Zero, zero.classify());
}

#[test]
fn test_neg_zero() {
    let neg_zero: f16 = -0.0;
    assert_eq_f16!(0.0, neg_zero);
    ...
    assert_eq_f16!(Fp::Zero, neg_zero.classify());
}

#[test]
fn test_one() {
    let one: f16 = 1.0f16;
    assert_eq_f16!(1.0, one);
    ...
    assert_eq_f16!(Fp::Normal, one.classify());
}
...
fn test_classify() {
    ...
    let zero: f16 = 0.0f16;
    let neg_zero: f16 = -0.0;
    assert_eq_f16!(nan.classify(), Fp::Nan);
    assert_eq_f16!(inf.classify(), Fp::Infinite);
    assert_eq_f16!(neg_inf.classify(), Fp::Infinite);
    assert_eq_f16!(zero.classify(), Fp::Zero);
    assert_eq_f16!(neg_zero.classify(), Fp::Zero);
    assert_eq_f16!(1f16.classify(), Fp::Normal);
    assert_eq_f16!(1e-4f16.classify(), Fp::Normal);
    assert_eq_f16!(1e-5f16.classify(), Fp::Subnormal);
}
...
#[test]
fn test_abs() {
    assert_eq_f16!(f16::INFINITY.abs(), f16::INFINITY);
    assert_eq_f16!(1f16.abs(), 1f16);
    assert_eq_f16!(0f16.abs(), 0f16);
    assert_eq_f16!((-0f16).abs(), 0f16);
    assert_eq_f16!((-1f16).abs(), 1f16);
    assert_eq_f16!(f16::NEG_INFINITY.abs(), f16::INFINITY);
    assert_eq_f16!((1f16 / f16::NEG_INFINITY).abs(), 0f16);
    assert!(f16::NAN.abs().is_nan());
}

#[test]
fn test_signum() {
    assert_eq_f16!(f16::INFINITY.signum(), 1f16);
    assert_eq_f16!(1f16.signum(), 1f16);
    assert_eq_f16!(0f16.signum(), 1f16);
    assert_eq_f16!((-0f16).signum(), -1f16);
    assert_eq_f16!((-1f16).signum(), -1f16);
    assert_eq_f16!(f16::NEG_INFINITY.signum(), -1f16);
    assert_eq_f16!((1f16 / f16::NEG_INFINITY).signum(), -1f16);
...
fn test_mul_add() {
    ...
    assert_eq_f16!(inf.mul_add(7.8, 9.0), inf);
    assert_eq_f16!(neg_inf.mul_add(7.8, 9.0), neg_inf);
    assert_eq_f16!(8.9f16.mul_add(inf, 3.2), inf);
    assert_eq_f16!((-3.2f16).mul_add(2.4, neg_inf), neg_inf);
}
...
fn test_recip() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(1.0f16.recip(), 1.0);
    assert_eq_f16!(2.0f16.recip(), 0.5);
    assert_eq_f16!((-0.4f16).recip(), -2.5);
    assert_eq_f16!(0.0f16.recip(), inf);
    assert!(nan.recip().is_nan());
    assert_eq_f16!(inf.recip(), 0.0);
    assert_eq_f16!(neg_inf.recip(), 0.0);
}
...
fn test_powi() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(1.0f16.powi(1), 1.0);
    assert_approx_eq!((-3.1f16).powi(2), 9.61, F16_APPROX_L2);
    assert_approx_eq!(5.9f16.powi(-2), 0.028727, F16_APPROX_L2);
    assert_eq_f16!(8.3f16.powi(0), 1.0);
    assert!(nan.powi(2).is_nan());
    assert_eq_f16!(inf.powi(3), inf);
    assert_eq_f16!(neg_inf.powi(2), inf);
}
...
fn test_powf() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(1.0f16.powf(1.0), 1.0);
    ...
    assert_eq_f16!(8.3f16.powf(0.0), 1.0);
    assert!(nan.powf(2.0).is_nan());
    assert_eq_f16!(inf.powf(2.0), inf);
    assert_eq_f16!(neg_inf.powf(3.0), neg_inf);
}
...
fn test_sqrt_domain() {
    ...
    assert_eq_f16!((-0.0f16).sqrt(), -0.0);
    assert_eq_f16!(0.0f16.sqrt(), 0.0);
    assert_eq_f16!(1.0f16.sqrt(), 1.0);
    assert_eq_f16!(f16::INFINITY.sqrt(), f16::INFINITY);
}

#[test]
fn test_exp() {
    assert_eq_f16!(1.0, 0.0f16.exp());
    ...
    let neg_inf: f16 = f16::NEG_INFINITY;
    let nan: f16 = f16::NAN;
    assert_eq_f16!(inf, inf.exp());
    assert_eq_f16!(0.0, neg_inf.exp());
    assert!(nan.exp().is_nan());
}

#[test]
fn test_exp2() {
    assert_eq_f16!(32.0, 5.0f16.exp2());
    assert_eq_f16!(1.0, 0.0f16.exp2());

    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    let nan: f16 = f16::NAN;
    assert_eq_f16!(inf, inf.exp2());
    assert_eq_f16!(0.0, neg_inf.exp2());
...
fn test_ln() {
    ...
    assert_eq_f16!(inf.ln(), inf);
    assert!(neg_inf.ln().is_nan());
    assert!((-2.3f16).ln().is_nan());
    assert_eq_f16!((-0.0f16).ln(), neg_inf);
    assert_eq_f16!(0.0f16.ln(), neg_inf);
...
fn test_log() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(10.0f16.log(10.0), 1.0);
    assert_approx_eq!(2.3f16.log(3.5), 0.664858);
    assert_eq_f16!(1.0f16.exp().log(1.0f16.exp()), 1.0);
    assert!(1.0f16.log(1.0).is_nan());
    assert!(1.0f16.log(-13.9).is_nan());
    assert!(nan.log(2.3).is_nan());
    assert_eq_f16!(inf.log(10.0), inf);
    assert!(neg_inf.log(8.8).is_nan());
    assert!((-2.3f16).log(0.1).is_nan());
    assert_eq_f16!((-0.0f16).log(2.0), neg_inf);
    assert_eq_f16!(0.0f16.log(7.0), neg_inf);
}
...
fn test_log2() {
    ...
    assert_eq_f16!(inf.log2(), inf);
    assert!(neg_inf.log2().is_nan());
    assert!((-2.3f16).log2().is_nan());
    assert_eq_f16!((-0.0f16).log2(), neg_inf);
    assert_eq_f16!(0.0f16.log2(), neg_inf);
}
...
fn test_log10() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(10.0f16.log10(), 1.0);
    assert_approx_eq!(2.3f16.log10(), 0.361728);
    assert_approx_eq!(1.0f16.exp().log10(), 0.434294);
    assert_eq_f16!(1.0f16.log10(), 0.0);
    assert!(nan.log10().is_nan());
    assert_eq_f16!(inf.log10(), inf);
    assert!(neg_inf.log10().is_nan());
    assert!((-2.3f16).log10().is_nan());
    assert_eq_f16!((-0.0f16).log10(), neg_inf);
    assert_eq_f16!(0.0f16.log10(), neg_inf);
}
...
fn test_to_degrees() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(0.0f16.to_degrees(), 0.0);
    assert_approx_eq!((-5.8f16).to_degrees(), -332.315521, F16_APPROX_L4);
    assert_eq_f16!(pi.to_degrees(), 180.0);
    assert!(nan.to_degrees().is_nan());
    assert_eq_f16!(inf.to_degrees(), inf);
    assert_eq_f16!(neg_inf.to_degrees(), neg_inf);
...
fn test_to_radians() {
    ...
    let inf: f16 = f16::INFINITY;
    let neg_inf: f16 = f16::NEG_INFINITY;
    assert_eq_f16!(0.0f16.to_radians(), 0.0);
    ...
    assert_eq_f16!(inf.to_radians(), inf);
    assert_eq_f16!(neg_inf.to_radians(), neg_inf);
}
...
fn test_float_bits_conv() {
    assert_eq_f16!((1.0f16).to_bits(), 0x3C00);
    assert_eq_f16!((12.5f16).to_bits(), 0x4A40);
    assert_eq_f16!((1337.0f16).to_bits(), 0x6539);
    assert_eq_f16!((-14.25f16).to_bits(), 0xCB20);
