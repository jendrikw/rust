...
v(
    "android-cross-path",
    "target.arm-linux-androideabi.android-ndk",
    "Android NDK standalone path (deprecated)",
)
v(
    "i686-linux-android-ndk",
    "target.i686-linux-android.android-ndk",
    "i686-linux-android NDK standalone path",
)
v(
    "arm-linux-androideabi-ndk",
    "target.arm-linux-androideabi.android-ndk",
    "arm-linux-androideabi NDK standalone path",
)
v(
    "armv7-linux-androideabi-ndk",
    "target.armv7-linux-androideabi.android-ndk",
...
v(
    ...
    "target.x86_64-linux-android.android-ndk",
